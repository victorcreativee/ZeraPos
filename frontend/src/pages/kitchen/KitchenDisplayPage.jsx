...
function KitchenDisplayPage() {
  ...
  if (!kitchenScreenEnabled) {
    return <DisabledScreen type="Kitchen" />;
  }
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-950">
      <AppHeader
        ...
        subtitle="Food orders waiting for preparation"
  ...
  return (
    <div className="overflow-hidden border border-slate-200 bg-white shadow-sm">
      <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-4 py-3">
        ...
        <span className="bg-orange-100 px-3 py-2 text-sm font-black text-orange-700">
